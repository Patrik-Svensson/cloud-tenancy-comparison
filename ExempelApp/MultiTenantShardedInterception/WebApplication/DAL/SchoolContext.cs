...
namespace WebApplication.DAL
{
    public class SchoolContext : DbContext
    {
        ...
        {
            return "Server=tcp:exjobb-exempelapp.database.windows.net,1433;Initial Catalog=Interception02;Persist Security Info=False;User ID=Guest_CRM;Password=TreasuryGast!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        }
